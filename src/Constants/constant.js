...
export const lightGrayBg = '#F5F5F5'
export const darkText = 'action'
export const mailBoxbg = '#F2F6FC'
export const emptyProfileLogo = 'https://ssl.gstatic.com/ui/v1/icons/mail/profile_mask2.png'
...
export const EMPTY_TABS = {
    ...
    allmails: {
        heading: 'No conversations to show',
        subHeading: ''
    }
}